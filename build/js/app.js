...
/***/ function(module, exports, __webpack_require__) {
	...
	var _left = __webpack_require__(20);
	
	var _left2 = _interopRequireDefault(_left);
	
	var _right = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<div class=\"user\">\n\t\t<div class=\"avatar\">\n\t\t\t<img src=\"" + __webpack_require__(29) + "\" width=\"40\" height=\"40\" />\n\t\t</div>\n\t\t<div class=\"info\">\n\t\t\t<span class=\"nickname\">青阑</span>\n\t\t\t<a class=\"opt\" href=\"#\"><i class=\"iconfont\">&#xe601;</i></a>\n\t\t</div>\n\t</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatlist = __webpack_require__(39);
	
	var _initial = __webpack_require__(45);
	
	var _members = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatarea = __webpack_require__(68);
	
	var _chatarea2 = _interopRequireDefault(_chatarea);
	
	var _contactArea = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wgt_members = __webpack_require__(89);
	...
	exports.default = {
		...
		computed: {
			chatInfo: function chatInfo() {
				return _index2.default.state.chatList[_index2.default.state.currentChatIndex];
			},
			currentChatIndex: function currentChatIndex() {
				return _index2.default.state.currentChatIndex;
			},
			members: function members() {
				...
				return chatInfo.members.map(function () {});
			}
		}
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<div class=\"title-wrap\">\n\t\t<div class=\"wrap-poi\">\n\t\t\t<span class=\"poi-name\">{{chatInfo.nickname}}</span>\n\t\t\t<span v-if=\"chatInfo.members.length > 1\" class=\"poi-count\">({{chatInfo.members.length}})</span>\n\t\t\t<i v-if=\"currentChatIndex > -1\" class=\"iconfont poi-icon\">&#xe608;</i>\n\t\t</div>\n\t</div>\n\n\t<div class=\"chat-wrapper\">\n\t\t<div class=\"wrapper-bd\">\n\t\t\t<div v-if=\"currentChatIndex == -1\" class=\"no-bubble\">未选择聊天</div>\n\t\t\t\n\t\t\t<template v-else>\n\t\t\t\t<div class=\"bubble\">\n\t\t\t\t\t<div class=\"bubble-system\">\n\t\t\t\t\t\t<span class=\"system-content\">15:16</span>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<img class=\"bubble-avatar\" src=\"" + __webpack_require__(29) + "\" width=\"40\" height=\"40\" />\n\t\t\t\t\t<div class=\"bubble-content\">\n\t\t\t\t\t\t<div class=\"content-nickname\">哈哈镜</div>\n\t\t\t\t\t\t<div class=\"content-msg\">\n\t\t\t\t\t\t\t<pre>经典1987复古手工小棉袄   颜色深邃蓝  喜庆红  各种碎花,经典1987复古手工小棉袄   颜色深邃蓝  喜庆红  各种碎花</pre>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t\t<div class=\"bubble me\">\n\t\t\t\t\t<img class=\"bubble-avatar\" src=\"" + __webpack_require__(29) + "\" width=\"40\" height=\"40\" />\n\t\t\t\t\t<div class=\"bubble-content\">\n\t\t\t\t\t\t<div class=\"content-msg\">\n\t\t\t\t\t\t\t<pre>经典1987复古手工小棉袄   颜色深邃蓝  喜庆红  各种碎花,经典1987复古手工小棉袄   颜色深邃蓝  喜庆红  各种碎花</pre>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</template>\n\t\t\t\n\t\t</div>\n\t</div>\n\n\t<div class=\"chat-ft\">\n\t\t<div class=\"tool-bar\">\n\t\t\t<a class=\"bar-item\" href=\"\"><i class=\"iconfont\">&#xe60e;</i></a>\n\t\t\t<a class=\"bar-item\" href=\"\"><i class=\"iconfont\">&#xe607;</i></a>\n\t\t</div>\n\n\t\t<pre class=\"edit-area\" contenteditable=\"true\"></pre>\n\n\t\t<div class=\"action\">\n\t\t\t<span class=\"macos-hint\">按下Cmd+Enter换行</span>\n\t\t\t<a class=\"send-btn\" href=\"javascript:;\">发送</a>\n\t\t</div>\n\t</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<div class=\"title-wrap\">\n\t\t<div class=\"wrap-poi\">\n\t\t\t<span class=\"poi-name\">详细信息</span>\n\t\t</div>\n\t</div>\n\n\t<div class=\"conatct-bd\">\n\t\t<div class=\"avatar\">\n\t\t\t<img src=\"" + __webpack_require__(29) + "\" width=\"100\" height=\"100\" />\n\t\t</div>\n\t\t<div class=\"nickname-area\">\n\t\t\t<div class=\"nickname\">江东帆影</div>\n\t\t\t<i class=\"iconfont men\">&#xe60b;</i>\n\t\t\t<i class=\"iconfont women\">&#xe60d;</i>\n\t\t</div>\n\t\t<div class=\"signature\">江畔何人初见月，江月何年初照人</div>\n\t\t<div class=\"meta-area\">\n\t\t\t<div class=\"meta-item\">\n\t\t\t\t<span class=\"item-l\">备注：</span>\n\t\t\t\t<div class=\"item-r\">陆孤瞻</div>\n\t\t\t</div>\n\t\t\t<div class=\"meta-item\">\n\t\t\t\t<span class=\"item-l\">地区：</span>\n\t\t\t\t<div class=\"item-r\">广东 罗浮山</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"button-area\">\n\t\t\t<a class=\"send-btn\" href=\"javascript:;\">发消息</a>\n\t\t</div>\n\t</div>";
...
/***/ function(module, exports) {
	...
	module.exports = "<div>members</div>";
